...
<head>
  ...
  <?php include '../../common/dclmweb-head.php'; ?>
   ...
   <title>Asia Locations - Deeper Christian Life Ministry</title>
...
<div id="resurrect-container">
  ...
  <?php include '../../common/dclmweb-nav.php'; ?>
	...
	<div id="resurrect-banner">
		...
		<img width="960" height="250" src="images/banners/asia.jpg" class="attachment-resurrect-banner" alt="Asia (Banner)" />
		
			<!-- <h1><a href="locations/asia/" title="Asia">Locations - Asia</a>	</h1> -->

			<div class="ctfw-breadcrumbs"><a href="./">Home</a> > <a href="locations/">Locations</a> > <a href="locations/asia/">Asia</a></div>
