...
<?php
 ...
 for ($s_ct=1; $s_ct < count($biblestudy); $s_ct++) {
    // if ($s_ct == 1) {
...
';
    ...
    if (($biblestudy[$s_ct]["High"] != "") || ($biblestudy[$s_ct]["Low"] != "")) {
	$video_to_show = "";
	if ($biblestudy[$s_ct]["High"] != "")
		$video_to_show = $biblestudy[$s_ct]["High"] ;
	else
		$video_to_show = $biblestudy[$s_ct]["Low"] ;
        echo '	        <li>  ';
	echo '		<a href="' . $video_to_show . '?player=video"><span class="resurrect-button-icon el-icon-video"></span>Watch</a> ';
        echo ' 		</li> ';
    }
    if ($biblestudy[$s_ct]["Audio"] != "") {
        echo '		<li>';
        echo '			<a href="' . $biblestudy[$s_ct]["Audio"] . '?player=audio"><span class="resurrect-button-icon el-icon-headphones"></span>Listen</a> ';
        echo '		</li> ';
    }    
    echo '	</ul> ';
