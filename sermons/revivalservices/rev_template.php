...
<head>
  ...
  <?php include dirname(__FILE__) . '/../../common/dclmweb-head.php'; ?>
   ...
   <title>Revival Service Sermons - Deeper Christian Life Ministry</title>
  ...
  <?php include dirname(__FILE__) . '/../../common/dclmweb-nav.php'; ?>
	...
	<div id="resurrect-banner">
		...
		<img width="960" height="250" src="images/bible2-banner-960x250.jpg" class="attachment-resurrect-banner" alt="Bible 2 (Banner)" />
			...
			<h1>
				<a href="sermons/" title="Sermon Archive">Sermons - Revival Service</a>
			</h1>

			<div class="ctfw-breadcrumbs"><a href="http://dclm.org/">Home</a> > <a href="sermons/">Sermon Archive</a> > <a href="sermons/revivalservices/">Revival Service Service</a></div>
...
?>
	...
	<div id="resurrect-sidebar-right" role="complementary">
		...
		<h1 class="resurrect-widget-title">Revival Service Archives</h1>				<ul>
			<li class="cat-item"><a href="sermons/revivalservices/2013/" title="View Revival Service Sermons">2013 Services</a></li>
			<li class="cat-item"><a href="sermons/revivalservices/2012/" title="View Revival Service Sermons">2012 Services</a></li>
			<li class="cat-item"><a href="sermons/revivalservices/2011/" title="View Revival Service Sermons">2011 Services</a></li>
			<li class="cat-item"><a href="sermons/revivalservices/2010/" title="View Revival Service Sermons">2010 Services</a></li>
		</ul>
	    </aside>
